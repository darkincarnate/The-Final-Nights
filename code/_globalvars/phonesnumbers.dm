...
GLOBAL_VAR_INIT(endronexecutivenumber, "")
GLOBAL_VAR_INIT(endronchiefnumber, "")
GLOBAL_VAR_INIT(internalaffairsnumber, "")
...
GLOBAL_VAR_INIT(endronexecutivename, "")
GLOBAL_VAR_INIT(endronchiefname, "")
GLOBAL_VAR_INIT(internalaffairsname, "")
